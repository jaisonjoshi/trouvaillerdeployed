...
const InterestForm = () => {
    return(
            <div className="interest  px-4 sm:px-16 md:px-20 2xl:px-40 py-20">
            ...
            <div>
                <form action="" className="flex my-16 gap-4 md:gap-12 flex-wrap text-white font-semibold items-end">
