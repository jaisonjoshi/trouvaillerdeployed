...
const EmiCard = () => {
  return (
    <div className=" flex">
      <div className="w-[60%] gradientbg text-center flex flex-col gap-2 py-12 items-center">
        <h2 className="text-[#F1ECEC] text-lg font-medium roboto">Explore Trouvailler EMI Schemes</h2>
      ...
      <div className="emihomecard w-[40%]">
