...
const navigate = useNavigate()
  ...
  return (
    <div className={`animationset ${anim}`}>
      <div className=" w-full relative h-[100vh] sm:h-[90vh] background-header">
           <NavbarTest color={color}/>
             
        <div className=" absolute z-[100] top-0 left-0 right-0 h-[100vh] sm:h-[90vh] pb-20 w-full flex flex-col lg:flex-row justify-start pl-4  sm:pl-12 lg:pl-16 2xl:pl-36 items-start ">
          <div className='flex flex-col items-start mt-40 lg:mt-52 2xl:mt-56 w-[100%] lg:w-[60%] 2xl:w-[50%]'>
          <h1 className="text-2xl md:text-3xl 2xl:text-4xl text-whiteglow mb-4 font-bold text-left">
          Discover Your </h1><h1 className=' w-full mt-1 2xl:mt-3 title-font text-3xl md:text-4xl 2xl:text-5xl text-whiteglow font-extrabold text-left'>Next Adventure <span className='text-[#00c676]'>with Us</span>
          </h1>
          <p className="text-base md:text-lg w-[100%] lg:w-[70%] md:w-full  lg:text-xl text-whiteglow text-left pb-6 pt-10">
          ...
          <Link className="" to="/packages"> <button className="flex btn-animation justify-center items-center bg-[transparent] shadow-lg border border-[#00A651] rounded-full text-whiteglow w-36 font-bold p-2 my-2 hover:bg-[#00A651] duration-500">
            <span className='relative z-[110]'>Explore</span>
          </button></Link>
          <div className='rounded-full mt-12 lg:mt-20 bg-[white] px-2 py-1 flex justify-between shadow-xl w-[95%] sm:w-[80%] md:w-[60%] lg:w-[90%] xl:w-[80%]'>
          <input onChange={handleSearchChange} type="text" placeholder='Search places ' className='outline-none rounded border-none text-sm md:text-base focus:ring-[transparent]  focus:border-[transparent]'/>
...
Know more
      ...
      <div className=' pt-12 md:pt-16 sm:pt-28 pb-8   px-4 sm:px-16 md:px-20 2xl:px-40'>
          <div className='text-left'>
            ...
            <p className=' pt-4 textnormal mb-8  md:text-lg'>Have a plan to go vacation? See trending destinations for your inspiration where to go.</p>
          </div>
        </div>
        ...
        <div className='p-7 text-center   mb-12'>
          <Link to="/packages" ><button className='font-medium btn-animation border-[#00c676] border p-2 rounded-[10px] w-full sm:w-auto px-10 ' ><span className='relative z-[110]'>More destinations</span></button></Link>
        </div>
...
<div className="mt-8 sm:mt-[2rem] py-2 sm:py-8 rounded-[10px] mb-12 sm:mb-0 mx-4 sm:mx-16 md:mx-20 2xl:mx-40 ">
      ...
      <div className=' pb-12 pt-20 px-4  sm:px-16 md:px-20 2xl:px-40'>
        <div className='flex w-full flex-col xl:flex-row'>
          <div className='w-[100%] xl:w-[30%] flex  items-center xl:bg-[#93FFD1] rounded-[10px] justify-center'>
          <h1 className='font-bold text-2xl w-full sm:text-3xl text-left xl:text-center xl:pt-7 mb-8'>What People<br className='hidden xl:block'/> Say About Us </h1>
