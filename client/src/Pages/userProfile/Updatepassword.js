                    ...
                    <div className="w-[100%] flex flex-col gap-[10px] items-start">
                       ...
                       <form action="" className='flex flex-col gap-[10px] items-start text-sm'>
                           <label>Type your new password</label>
                            ...
                            <button  className="flex justify-center items-center bg-evergreen text-blacky-medium w-36  rounded-md p-2 my-5 hover:bg-whiteglow duration-500">Update</button>
                       </form>
                    </div>
                </div>
            </div>
