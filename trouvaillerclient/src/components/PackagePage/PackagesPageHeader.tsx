        ...
        <div className="relative pb-16">
            ...
            <div className=" relative text-center z-[20] pt-32 xs:pt-40 lg:pt-48 xl:pt-56 pb-8 xs:pb-20 px-8 sm:px-20 xl:px-60 text-white">
                <div className="flex flex-col items-center">
                    <div className="  poppins"> <h1 className="font-bold text-[24px] xs:text-[32px] md:text-[36px] lg:text-[40px] xl:text-[28px] ">  Let Us Make Your Travel Experience</h1><h1 className="font-extrabold text-[24px] xs:text-[34px] sm:ext-[36px] md:text-[40px] lg:text-[50px] xl:text-[48px] ">
                    Truly  <span className="text-[#42b53c]"> Memorable!</span></h1></div>
                    <p className="text-sm leading-[24px] xs:leading-normal xs:text-base md:text-lg  xl:w-[60%] lg:text-lg my-8 xl:my-8 poppins text-[#e4e4e4]">Explore our diverse range of meticulously curated travel packages designed to cater to every wanderlust, ensuring an unforgettable journey for every traveler.</p>
                </div>
