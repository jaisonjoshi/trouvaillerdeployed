    ...
    return(
        <div className="flex flex-col-reverse md:flex-row items-start xl:mt-24  shadow-custom2 rounded-[10px] py-4 px-4 md:px-8">
            <div className="w-[100%] md:w-[65%] lg:pt-12"> 
                <h2 className="hidden md:block md:text-[26px] roboto-mediunm lg:text-[32px] xl:text-[30px] font-bold">Now you can travel stress-free with our flexible EMI plans.</h2>
