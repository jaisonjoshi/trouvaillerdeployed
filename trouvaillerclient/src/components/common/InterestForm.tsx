...
export const InterestForm = () => {
    return(
        <div>
              <h1 className="text-2xl sm:text-2xl lg:text-3xl 2xl:text-4xl font-bold mb-2 md:mb-4 roboto">You want a customised travel plan?</h1>
            <p className="text-sm xs:text-base md:text-lg lg:text-lg text-[#777777] poppins">Looking for a personalized travel experience? Fill out the form below to create your customized travel plan tailored to your preferences and desires.</p>
